...
export type WebhooksStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type WebhooksStatusQuery = { __typename?: 'Query', app?: { __typename?: 'App', name?: string | null, webhooks?: Array<{ __typename?: 'Webhook', id: string, name: string, isActive: boolean, targetUrl: string, subscriptionQuery?: string | null, asyncEvents: Array<{ __typename?: 'WebhookEventAsync', name: string, eventType: WebhookEventTypeAsyncEnum }>, eventDeliveries?: { __typename?: 'EventDeliveryCountableConnection', edges: Array<{ __typename?: 'EventDeliveryCountableEdge', node: { __typename?: 'EventDelivery', createdAt: any, status: EventDeliveryStatusEnum, eventType: WebhookEventTypeEnum, attempts?: { __typename?: 'EventDeliveryAttemptCountableConnection', edges: Array<{ __typename?: 'EventDeliveryAttemptCountableEdge', node: { __typename?: 'EventDeliveryAttempt', createdAt: any, response?: string | null, responseStatusCode?: number | null, status: EventDeliveryStatusEnum } }> } | null } }> } | null }> | null } | null };
...
export const FetchAppDetailsDocument = gql`
  ...
  app {
    ...
    `;
export const WebhooksStatusDocument = gql`
    query WebhooksStatus {
  app {
    name
    webhooks {
      id
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    WebhooksStatus(variables?: WebhooksStatusQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<WebhooksStatusQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<WebhooksStatusQuery>(WebhooksStatusDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'WebhooksStatus', 'query');
    },
